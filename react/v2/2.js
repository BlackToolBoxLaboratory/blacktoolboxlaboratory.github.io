...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);
function i(t){return(i="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function s(t,o,e){return o in t?Object.defineProperty(t,o,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[o]=e,t}function a(t,o){var e=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);o&&(n=n.filter((function(o){return Object.getOwnPropertyDescriptor(t,o).enumerable}))),e.push.apply(e,n)}return e}function u(t){for(var o=1;o<arguments.length;o++){var e=null!=arguments[o]?arguments[o]:{};o%2?a(Object(e),!0).forEach((function(o){s(t,o,e[o])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(e)):a(Object(e)).forEach((function(o){Object.defineProperty(t,o,Object.getOwnPropertyDescriptor(e,o))}))}return t}function c(t,o){return function(t){if(Array.isArray(t))return t}(t)||function(t,o){if("undefined"==typeof Symbol||!(Symbol.iterator in Object(t)))return;var e=[],n=!0,r=!1,i=void 0;try{for(var s,a=t[Symbol.iterator]();!(n=(s=a.next()).done)&&(e.push(s.value),!o||e.length!==o);n=!0);}catch(t){r=!0,i=t}finally{try{n||null==a.return||a.return()}finally{if(r)throw i}}return e}(t,o)||function(t,o){if(!t)return;if("string"==typeof t)return l(t,o);var e=Object.prototype.toString.call(t).slice(8,-1);"Object"===e&&t.constructor&&(e=t.constructor.name);if("Map"===e||"Set"===e)return Array.from(t);if("Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return l(t,o)}(t,o)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function l(t,o){(null==o||o>t.length)&&(o=t.length);for(var e=0,n=new Array(o);e<o;e++)n[e]=t[e];return n}var f=function(t){var o=0,e=0;if(t.offsetParent)do{o+=t.offsetLeft,e+=t.offsetTop}while(t=t.offsetParent);return{left:o-window.scrollX,top:e-window.scrollY}},w=function(t,o){var e;return o.forEach((function(o){e=Object.assign({},e,p(t,o))})),e},p=function(t,o){var e={};return"object"===i(t)&&Object.keys(t).find((function(n){if(n===o)return e=Object.assign({},t[n]),!0})),e},h=react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef((function(i,s){var a,l,p,h,g,v,d,y={state_showState:(p=i.showState,h=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(p),g=c(h,2),v=g[0],d=g[1],{value:v,onToggle:function(t){d("boolean"==typeof t?t:!v)}}),state_autoAdjust:b({position:"",align:""}),autoDetect:void 0===i.autoDetect||i.autoDetect,withArrow:void 0===i.withArrow||i.withArrow,showPosition:i.showPosition?i.showPosition:"bottom",showAlign:i.showAlign?i.showAlign:"begin",styleObj:(a=i.styleObj||{},l={},Object.keys(a).forEach((function(t){l[t]={},Object.keys(a[t]).forEach((function(o){var e=o.replace(/-(\w)/g,(function(t,o){return o.toUpperCase()}));l[t][e]=a[t][o]}))})),l)},m=Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null),j=Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null),O=y.state_autoAdjust.value.position||y.showPosition,S=y.state_autoAdjust.value.align||y.showAlign;function P(){y.autoDetect&&y.state_autoAdjust.onAdjust(u(u(u({},y.state_autoAdjust.value),function(){var t=m.current,o=j.current,e=f(t);if(e.left-o.scrollWidth<0){if("left"===y.showPosition)return{position:"right"};if("top"===y.showPosition||"bottom"===y.showPosition)return{align:"begin"}}else if(e.left+t.scrollWidth+o.scrollWidth+20>window.innerWidth){if("right"===y.showPosition)return{position:"left"};if("top"===y.showPosition||"bottom"===y.showPosition)return{align:"end"}}return{}}()),_()))}function A(){y.autoDetect&&y.state_autoAdjust.onAdjust(u(u({},y.state_autoAdjust.value),_()))}function _(){var t=m.current,o=j.current,e=f(t);if(e.top-o.scrollHeight<0){if("top"===y.showPosition)return{position:"bottom"};if("left"===y.showPosition||"right"===y.showPosition)return{align:"begin"}}else if(e.top+t.scrollHeight+o.scrollHeight+20>window.innerHeight){if("bottom"===y.showPosition)return{position:"top"};if("left"===y.showPosition||"right"===y.showPosition)return{align:"end"}}return{}}return Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])((function(){return P(),window.addEventListener("resize",P),window.addEventListener("scroll",A),function(){window.removeEventListener("resize",P),window.removeEventListener("scroll",A)}}),[]),Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])((function(){P()}),[y.state_showState.value,O,S]),Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])((function(){void 0!==i.showState&&y.state_showState.value!==i.showState&&y.state_showState.onToggle(i.showState)})),react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{ref:s,className:classnames__WEBPACK_IMPORTED_MODULE_1___default()("btb-react-popover",i.className,"popover-align-".concat(S),{"popover-arrow":y.withArrow}),style:w(y.styleObj,["btb-react-popover","popover-align-".concat(S),y.withArrow?"popover-arrow":""])},react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{ref:m,className:"popover_trigger",style:w(y.styleObj,["popover_trigger"]),onClick:function(){i.stateLock||(void 0!==i.onToggle&&i.onToggle(!y.state_showState.value),y.state_showState.value?void 0!==i.onHide&&i.onHide():void 0!==i.onShow&&i.onShow(),y.state_showState.onToggle())}},void 0!==i.trigger?i.trigger:"Trigger"),react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{ref:j,className:classnames__WEBPACK_IMPORTED_MODULE_1___default()("popover_content",{"content-show":y.state_showState.value},"content-position-".concat(O)),style:w(y.styleObj,["popover_content",y.state_showState.value?"content-show":"","content-position-".concat(O)])},i.children||"Empty"))}));function b(t){var o=c(Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(t),2),e=o[0],r=o[1];return{value:e,onAdjust:function(t){r(t)}}}/* harmony default export */ __webpack_exports__["a"] = (h);
