import{p as r}from"./packageObj-7a57e3cd.js";import{d as w,bv as v,_ as p,r as a,o as u,c as m,w as t,a as l,M as n,f as e,e as i}from"./index-bd8b578a.js";const x=`<btb-vue-list :dataList="listData"/>
      <template #b2>
...
</btb-vue-list>`,y=[{id:"b1",title:"Branch: 1",children:[{id:"l11",title:"Leaf: 1-1"},{id:"b12",title:"Branch: 1-2",children:[{id:"l121",title:"Leaf: 1-2-1"},{id:"l122",title:"Leaf: 1-2-2"}]},{id:"l13",title:"Leaf: 1-3"}]},{id:"b2",title:"Branch: 2",children:[{id:"l21",title:"Leaf: 2-1"},{id:"l22",title:"Leaf: 2-2"}]}],S=w({name:"btb-pkg-list-example",setup(){return{version:r.list.version,updated:r.list.updated,btnList:[{id:"github",fa:["fab","github"],url:"https://github.com/BlackToolBoxLaboratory/vue-list"},{id:"npm",fa:["fab","npm"],url:"https://www.npmjs.com/package/@blacktoolbox/vue-list"}],exampleRender:x,listData:y,openLink:v}}}),$=i("br",null,null,-1),D=i("pre",null,`const listData = [
