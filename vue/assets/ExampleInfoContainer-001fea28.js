import{d as k,u as T,s as A,t as h,bv as v,_ as m,r as o,o as u,c as f,w as a,a as n,M as d,f as t,e as s}from"./index-eb68d8c1.js";import{p as I}from"./packageInfo-7b6d605e.js";import"./packageObj-2fa2689f.js";const $=[{name:"Name",id:"name"},{name:"Type",id:"devType"},{name:"OS",id:"osType"},{name:"IP",id:"ipAddr"},{name:"MAC",id:"macAddr"},{name:"Traffic(tx / rx)",id:"traffic"},{name:"Statue",id:"statusDesc"}],C=[{name:"Device 1",devType:"phone",osType:"ios",ipAddr:"192.168.0.50",macAddr:"B4:A2:07:44:55:2A",traffic:"1.7 MB / 45 KB",status:0,statusDesc:"Disconnected"},{name:"Device 2",devType:"notebook",osType:"windows",ipAddr:"192.168.0.52",macAddr:"B4:A2:07:44:DD:FF",traffic:"4.8 MB / 27 KB",status:0,statusDesc:"Disconnected"}],M=`<btb-vue-table 
        :headData="headData" 
        :bodyData="bodyData"
        mode="info"
/>`,S=`const headData = [
